...
class Person(models.Model):
    ...
    user_type = models.CharField(max_length=1, choices=Person_type.choices, default=Person_type.CLIENT)
    address = models.ForeignKey('api.Address', on_delete=models.PROTECT)
